...
const Footer = () => {
  return (
    <div className="px-8 md:px-12 lg:px-16 bg-footer-bg bg-cover text-white">
      <div className="flex border-b border-brand py-16 lg:py-32 xl:px-32">
        <div className="basis-1/3 flex items-center justify-center">
          <img src={logo} alt="banani club logo" />
        </div>
        <div className="flex flex-wrap basis-2/3 flex-col items-center">
      ...
      <div className="py-10 w-full flex justify-center">
        <h1 className="tracking-[0.15rem] sm:tracking-[0.25rem] text-xs font-poppins">
