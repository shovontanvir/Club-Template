...
const ClubHistoryCard = () => {
  const getHistoryData = () => {
    ...
    return axios.get("http://localhost:4040/club-history");
  };
  ...
  return (
    <div className="flex flex-col sm:flex-row justify-between items-center px-8 sm:px-12 md:px-16 lg:px-24 xl:px-32 py-16 md:py-28 relative ">
      <div className="basis-1/4">
        <div className="after:absolute after:h-full relative after:left-4 after:border-2 after:-top-4 after:border-brand after:opacity-50 after:w-1/2 sm:after:w-full">
          ...
          />
          <div className="absolute w-1/2 inset-0 bg-black bg-opacity-30"></div>
        </div>
      </div>
      <div className="basis-3/4 sm:pl-16 mt-5 sm:mt-0 flex flex-col justify-between">
        <div>
          <p
            className="font-poppins font-extralight text-[#6A6E71] mt-2 leading-7 text-sm md:text-base text-justify"
